...
const Player = ({ setIsShowRightSidebar }) => {
  ...
  return (
    <div className="bg-main-400 px-5 h-full flex">
      <div className="w-[30%] flex-auto flex gap-3 items-center sm:hidden">
        <img
        ...
        <div className="flex gap-4 pl-2 cursor-pointer sm:hidden">
          {!isHeart ? (
      ...
      <div className="w-[30%] flex-auto flex items-center justify-end gap-4 sm:hidden">
        ...
        <span
          ...
          className="p-1 rounded-lg cursor-pointer bg-main-500 opacity-90 hover:opacity-100 "
        >
